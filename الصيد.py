    ...
    try:
        ch = await jmrobot(
            functions.channels.CreateChannelRequest(
                title="sorce-max - صيد ماكس",
                about="This channel to hunt username by - @Turbo_ismax ",
            )
        )
        ...
        if isav == True:
            try:
                ...
                await event.client.send_file(
                    event.chat_id,
                    "https://t.me/dhdjdbfjfbfh/8",
                    caption="🐊 MAX the best 🐊\n- - - - - - - - - - - - - - - - - - - - - - - -\n- UserName: ❲ @{} ❳\n- ClickS: ❲ {} ❳\n- Type: {}\n- Save: ❲ Chaneel ❳\n- - - - - - - - - - - - - - - - - - - - - - - -\nThE KiNgS ❲ @Turbo_ismax - @Y_Y_a ❳ ".format(
                ...
                await event.client.send_message(
                    "@Turbo_ismax", f"- Done : @{username} !\n- By : @Y_Y_a - @Turbo_ismax !"
                )
                sedmod = False
                break
